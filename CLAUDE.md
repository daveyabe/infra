...
**YOU ARE IN: `infrastructure/polecats/nux/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/infrastructure/` (rig root) or other directories
...
**Your mail address:** `infrastructure/polecats/nux`
**Your rig:** infrastructure
**Your Witness:** `infrastructure/witness`
...
| Ask Witness for help | `gt mail send infrastructure/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`infrastructure/witness`) when:
...
```bash
gt mail send infrastructure/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
